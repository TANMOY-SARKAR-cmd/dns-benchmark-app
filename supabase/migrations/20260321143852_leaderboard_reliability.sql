ALTER TABLE public.leaderboard ADD COLUMN IF NOT EXISTS reliability_score double precision;
...
BEGIN
    ...
    INSERT INTO leaderboard (provider, avg_latency, success_rate, sample_count, score, reliability_score, last_updated)
    SELECT
        provider,
